...
// Forum creation (protected by session-based auth)
Route::middleware(['auth'])->post('/api/forum', [ForumController::class, 'store']);

// Post creation (protected by session-based auth)
Route::middleware(['auth'])->post('/api/posts', [PostController::class, 'store']);
